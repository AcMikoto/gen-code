...
| `/init` | Create memory files (`GEN.md` by default, `--claude` or `--codex` for compatible files) |
...
TestHandleInitCommand                     — /init creates native or compatible memory files
...
# Create a Codex-compatible project memory file
