...
Config lives in `~/.gen/` (user) and `<project>/.gen/` (project, overrides user). Project memory is loaded as a mutable reminder from the first available file in this order: `.gen/GEN.md`, `GEN.md`, `.claude/CLAUDE.md`, `CLAUDE.md`, `AGENTS.md`.
